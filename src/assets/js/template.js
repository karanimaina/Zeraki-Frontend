...
$('.demo-panel-bx').slimScroll({
  ...
  // Close
    ...
    // Hide mobile scrollable btoom nav on click
    ...
    // Slide up on button press
    $(document).on('click', '.box-btn-slide-close', function(){
      $(this).parents('.box').find('.box-content, .box-body').slideToggle();
      $(this).parents('.box').find('.box-btn-slide').toggleClass('rotate-180');
      $(this).parents('.box').find('.bi-caret-down-fill').toggleClass('rotate-180');
    });
    ...
    //     $('body').toggleClass('dark-skin').removeClass('light-skin');
    //   } else if ( $('body').hasClass('dark-skin') ) {
    //     $('body').toggleClass('light-skin').removeClass('dark-skin');
    //   }
    // });
    ...
    // Print
    //
    $(document).on('click', '.printRF', function(){
      var innerContents = document.getElementById('printRF').innerHTML;
      //var allContent =
      var popupWinindow = window.open('', '_blank', 'width=device-width');
      popupWinindow.document.open();
      popupWinindow.document.write('<!DOCTYPE html><html><head><link rel="stylesheet" href="styles.scss"><link rel="stylesheet" href="assets/css/vendor_css.css"><link rel="stylesheet" href="assets/vendor_components/bootstrap/dist/css/bootstrap.min.css"><script>window.onload= function () { window.print();window.close();   }  </script></head><body>' + innerContents + '</html>');
    ...
    $(document).on('click', '#chat-circle, #chat-box-toggle, #chat-popup', function(){
      $("#chat-box-body").toggleClass("show");
      $("#whatsapp-box-body").removeClass("show");
      $("#tel-box-body").removeClass("show");
    });
    $(document).on('click', '#whatsapp-box-toggle, #whatsapp-popup', function(){
      $("#whatsapp-box-body").toggleClass("show");
      $("#chat-box-body").removeClass("show");
      $("#tel-box-body").removeClass("show");
    });
    $(document).on('click', '#tel-box-toggle, #tel-popup', function(){
      $("#tel-box-body").toggleClass("show");
      $("#chat-box-body").removeClass("show");
      $("#whatsapp-box-body").removeClass("show");
    });
...
// Close bottom nav on Mobile Nav click
$(document).on('click', '.mobile-nav-collapsed', function(){
  $(".mobile-nav-collapsed").toggleClass('collapsed');
